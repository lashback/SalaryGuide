...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.total_budget'
        db.add_column(u'salaries_organization', 'total_budget',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.total_budget'
        db.delete_column(u'salaries_organization', 'total_budget')
