...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.position_percentile'
        db.add_column(u'salaries_employee', 'position_percentile',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.college_percentile'
        db.add_column(u'salaries_employee', 'college_percentile',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.total_percentile'
        db.add_column(u'salaries_employee', 'total_percentile',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.position_percentile'
        db.delete_column(u'salaries_employee', 'position_percentile')

        # Deleting field 'Employee.college_percentile'
        db.delete_column(u'salaries_employee', 'college_percentile')

        # Deleting field 'Employee.total_percentile'
        db.delete_column(u'salaries_employee', 'total_percentile')
